...
const nodes = [
  {
    type: "NodeJs",
    label: <NodeJsIcon className="h-10 w-10" />,
    className: "top-9",
    lineHeight: "h-30",
  },
  {
    type: "ExpressJs",
    label: <ExpressJsIcon className="h-10 w-10" />,
    className: "-top-16",
    lineHeight: "h-55",
  },
  {
    type: "NestJS",
    label: <NestJsIcon className="h-10 w-10" />,
    className: "top-9",
    lineHeight: "h-30",
  },
  {
    type: "GraphQL",
    label: <GraphQlIcon className="h-10 w-10 " />,
    className: "-top-16",
    lineHeight: "h-55",
  },
  {
    type: "RestApi",
    label: <RestApiIcon className="h-10 w-10" />,
    className: "top-9",
    lineHeight: "h-30",
  },
  {
    type: "Authentication",
    label: <AuthIcon className="h-10 w-10" />,
    className: "-top-16",
    lineHeight: "h-55",
  },
  {
    type: "Server",
    label: <ServerIcon className="h-10 w-10" />,
    className: "top-9",
    lineHeight: "h-30",
  },
];
