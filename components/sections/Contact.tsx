    ...
    <div className="app-container mt-14 md:mt-44" id="Contact">
      <div className="grid md:grid-cols-2 gap-10 md:gap-24 items-start">
        ...
        <Paper className="border p-6 border-primary rounded-4xl">
          ...
          <p className="mt-4">
            Available for remote work globally, I collaborate with clients from
            different parts of the world, providing consistent communication,
            flexibility, and dependable results.
          </p>
          <div className="mt-6 grid gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-heading font-semibold">+639304866849</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="p-2 rounded-md bg-primary">
